...
@hydra.main(config_path="conf", config_name="fingerTip")
def main(cfg):
    # Initialize digits
    bg = cv2.imread("resources/bg_digit_240_320.jpg")
    digits = tacto.Sensor(**cfg.tacto, config_path="conf/config_fingerTip.yml", background=bg)
